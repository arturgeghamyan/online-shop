							...
							<form action="#">
								...
								<div class="order-info bg-white text-center clearfix mb-30">
									...
									<div class="single-order-info">
										...
										<p class="text-uppercase text-light-black mb-0"><strong>{{$order['date']}}</strong></p>
									</div>
									<div class="single-order-info">
										<h4 class="title-1 text-uppercase text-light-black mb-0">Total</h4>
										<p class="text-uppercase text-light-black mb-0"><strong>$ {{$order['total']}}</strong></p>
									</div>
									<div class="single-order-info">
										<h4 class="title-1 text-uppercase text-light-black mb-0">payment method</h4>
										<p class="text-uppercase text-light-black mb-0"><a href="{{url('product/order/details'.$order['id'])}}"><strong>check payment</strong></a></p>
									</div>
								</div>
								@endforeach
